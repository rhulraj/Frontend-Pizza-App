        ...
        <>
           <section className="text-gray-600 body-font">
                ...
                <div className="hidden pr-0 lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 md:block">
                   ...
                   <form className="flex flex-col w-full p-8 mt-10 bg-gray-100 rounded-lg lg:w-2/6 md:w-1/2 md:ml-auto md:mt-0" action="">
                        <h2 className="mb-5 text-lg font-meduim text-gray-900 title-font">Sign up</h2>
                        <div className="relative mb-4">
                            <label htmlFor="firstName" className="text-sm leading-7 text-gray-600">Full Name</label>
                        ...
                        <div className="relative mb-4">
                            <label htmlFor="mobileNumber" className="text-sm leading-7 text-gray-600">Phone Number<span className="text-red-500">*</span></label>
                        ...
                        <p className="mt-3 text-x5 text-gray-500">Already have an account? 
                            <Link to="/login" className="text-yellow-500">Login</Link></p>
                   </form>
                </div>
           </section>
        </>
...
export default SignPresentation;